...
(function (BABYLON) {
    var Bowling = /** @class */ (function () {
        ...
        Bowling.prototype._initGeometries = function () {
            ...
            skyboxMaterial.reflectionTexture = new BABYLON.CubeTexture('../assets/Ely31', this.scene);
        ...
        Bowling.prototype._initInteractions = function () {
            ...
            this.scene.onPointerObservable.add(function (data) {
                ...
                if (data.pickInfo.pickedMesh === _this.boule) {
                    ...
                    _this.boule.applyImpulse(data.pickInfo.ray.direction.multiplyByFloats(50, 50, 50), data.pickInfo.pickedPoint);
                }
            });
        };
        return Bowling;
