module BABYLON {
    ...
    export class Bowling implements IBowling {
        ...
        private _initGeometries(): void {
            ...
            skyboxMaterial.reflectionTexture = new CubeTexture('../assets/Ely31', this.scene);
        ...
        private _initInteractions(): void {
            this.scene.onPointerObservable.add((data) => {
                ...
                if (data.pickInfo.pickedMesh === this.boule) {
                    ...
                    this.boule.applyImpulse(data.pickInfo.ray.direction.multiplyByFloats(50, 50, 50), data.pickInfo.pickedPoint);
                }
            });
        }
    }
